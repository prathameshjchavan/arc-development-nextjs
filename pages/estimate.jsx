...
// Animations Data
import estimateAnimation from "../src/animations/estimateAnimation/data";
		...
		<Grid container>
			<Head>
				...
				<meta
					property="og:url"
					key="og:url"
					content="arcsoftwaredevelopment.com/estimate"
				/>
				<link
					rel="canonical"
					key="canonical"
			...
			>
				...
				>
					<Typography variant="h1" align={matchesLG ? "center" : "left"}>
						Estimate
					</Typography>
				</Grid>
				<Grid
