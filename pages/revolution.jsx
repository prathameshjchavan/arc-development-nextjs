...
// Animations data
import technologyAnimation from "../src/animations/technologyAnimation/data";
		...
		<Grid container direction="column">
			<Head>
				...
				<meta
					property="og:url"
					key="og:url"
					content="arcsoftwaredevelopment.com/revolution"
				/>
				<link
					rel="canonical"
					key="canonical"
			...
			<Grid item sx={sx.rowContainer} style={{ marginTop: "2em" }}>
				<Typography
					variant="h1"
			...
			>
				<Grid item lg>
					<img
						...
						style={{
							maxWidth: matchesSM ? 300 : matchesMD ? "30em" : "40em",
			...
			{/* -----Process----- */}
			<Grid item container justifyContent="center" sx={sx.rowContainer}>
				<Grid item>
			...
			>
				<Grid
					...
					container
					direction="column"
					alignItems={matchesLG ? "center" : "left"}
					lg
				>
					<Grid item>
						<Typography
			...
			>
				...
				<Grid item lg style={{ alignSelf: "center" }}>
					<img
						...
						style={{ width: "100%", maxWidth: matchesLG ? 700 : 1000 }}
			...
			>
				...
				<Grid item lg style={{ alignSelf: "center" }}>
					<img
						...
						style={{ width: matchesSM ? "90%" : "100%", maxWidth: 200 }}
						alt="rocket"
					/>
				</Grid>
			</Grid>
